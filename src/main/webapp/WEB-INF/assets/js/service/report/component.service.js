...
//    } 
    ...
    var createGroups = function(registers, component) {
        ...
        var keys = _.pluck(component.data.fields, 'to');
        return DataGrouperService.group(registers, keys);
    }
    
    var addSelectedFields = function(component) {
    	_.map(component.data.fields, function(field) {
            field.selected = true;
        });
    }

    //TODO tirar o createGroup quando for o header
    var createComponentField = function(registers, component) {
    	addSelectedFields(component);
